**Python-essay**
<!-- TOC -->autoauto- [1. 第一部分  Python简介与版本介绍](#1-第一部分--python简介与版本介绍)auto    - [1.1. Python简介](#11-python简介)auto    - [1.2. Python的设计模式](#12-python的设计模式)auto    - [1.3. 单例模式](#13-单例模式)auto        - [1.3.1. 使用`__new__`方法](#131-使用__new__方法)auto        - [1.3.2. 使用装饰器](#132-使用装饰器)auto        - [1.3.3. 使用元类](#133-使用元类)auto        - [1.3.4. import方法](#134-import方法)auto    - [1.4. Python中的元类(metaclass)](#14-python中的元类metaclass)auto    - [1.5. Python自省](#15-python自省)auto        - [1.5.1. 访问对象的属性](#151-访问对象的属性)auto        - [1.5.2. `insepect`模块自省](#152-insepect模块自省)auto    - [1.6. Python中的重载](#16-python中的重载)auto    - [1.7. <a href="#1.7">新式类和旧式类</a>](#17-a-href17新式类和旧式类a)auto    - [1.8. 鸭子模型](#18-鸭子模型)auto    - [1.9. Python中的作用域](#19-python中的作用域)auto    - [1.10. GIL线程全局锁](#110-gil线程全局锁)auto    - [1.11. Python里的拷贝](#111-python里的拷贝)auto    - [1.12. Python垃圾回收机制](#112-python垃圾回收机制)auto        - [1.12.1. 引用计数](#1121-引用计数)auto        - [1.12.2. 标记-清除机制](#1122-标记-清除机制)auto        - [1.12.3. 分代技术](#1123-分代技术)auto    - [1.13. Python2.x与Python3.x区别](#113-python2x与python3x区别)auto- [2. 第二部分  Python语言基础](#2-第二部分--python语言基础)auto    - [2.1. 标识符、变量与常量](#21-标识符变量与常量)auto    - [2.2. 数据类型](#22-数据类型)auto        - [2.2.1. 字符串格式化](#221-字符串格式化)auto        - [2.2.2. 列表、元组、字典、集合的区别](#222-列表元组字典集合的区别)auto    - [2.3. 运算符与流程控制](#23-运算符与流程控制)auto        - [2.3.1. 运算符](#231-运算符)auto        - [2.3.2. 流程控制](#232-流程控制)auto    - [2.4. 函数使用](#24-函数使用)auto        - [2.4.1. 函数的基本定义](#241-函数的基本定义)auto        - [2.4.2. 变量作用域（LEGB）](#242-变量作用域legb)auto        - [2.4.3. 内置函数、模块函数及基本数据结构函数](#243-内置函数模块函数及基本数据结构函数)auto        - [2.4.4. 匿名函数](#244-匿名函数)auto        - [2.4.5. 递归函数](#245-递归函数)auto        - [2.4.6. 闭包与装饰器](#246-闭包与装饰器)auto        - [2.4.7. 迭代器与生成器](#247-迭代器与生成器)auto        - [2.4.8. 高级函数](#248-高级函数)auto        - [2.4.9. 匿名、递归、闭包、高级函数总结](#249-匿名递归闭包高级函数总结)auto        - [2.4.10. <a href='#IO编程'>目录管理与文件操作相关模块函数</a>](#2410-a-hrefio编程目录管理与文件操作相关模块函数a)auto        - [2.4.11. 时间、日期和日历相关模块函数](#2411-时间日期和日历相关模块函数)auto        - [2.4.12. 短信邮件相关模块函数](#2412-短信邮件相关模块函数)auto    - [2.5. 模块使用](#25-模块使用)auto    - [2.6. 异常处理](#26-异常处理)auto    - [2.7. 面向对象(继承性、多态性、封装性)](#27-面向对象继承性多态性封装性)auto        - [2.7.1. 类和对象的基本定义](#271-类和对象的基本定义)auto        - [2.7.2. 常见的魔法函数](#272-常见的魔法函数)auto        - [2.7.3. 枚举类的使用](#273-枚举类的使用)auto        - [2.7.4. 类的继承](#274-类的继承)auto        - [2.7.5. 多继承](#275-多继承)auto        - [2.7.6. 多态性](#276-多态性)auto        - [2.7.7. 封装性](#277-封装性)auto        - [2.7.8. 类属性](#278-类属性)auto        - [2.7.9. 类方法(classmethod)](#279-类方法classmethod)auto        - [2.7.10. 静态方法(staticmethod)](#2710-静态方法staticmethod)auto        - [2.7.11. 属性函数](#2711-属性函数)auto        - [2.7.12. 对象判断](#2712-对象判断)auto    - [2.8. IO编程](#28-io编程)auto        - [2.8.1. 文件读写](#281-文件读写)auto        - [2.8.2. `StringIO`和`BytesIO`](#282-stringio和bytesio)auto        - [2.8.3. `bytes`函数的使用](#283-bytes函数的使用)auto        - [2.8.4. 序列化](#284-序列化)auto    - [2.9. 异常处理](#29-异常处理)auto    - [2.10. 正则表达式](#210-正则表达式)auto        - [2.10.1. 正则基础](#2101-正则基础)auto        - [2.10.2. 正则规则](#2102-正则规则)auto        - [2.10.3. 正则高阶](#2103-正则高阶)auto    - [2.11. 进程](#211-进程)auto        - [2.11.1. 进程简介](#2111-进程简介)auto        - [2.11.2. 进程的并发与并行](#2112-进程的并发与并行)auto        - [2.11.3. 进程管理](#2113-进程管理)auto        - [2.11.4. 进程锁](#2114-进程锁)auto        - [2.11.5. 自定义进程](#2115-自定义进程)auto        - [2.11.6. 进程池](#2116-进程池)auto        - [2.11.7. 数据共享](#2117-数据共享)auto        - [2.11.8. 共享内存](#2118-共享内存)auto        - [2.11.9. 多进程应用举例](#2119-多进程应用举例)auto    - [2.12. 线程](#212-线程)auto        - [2.12.1. 线程简介](#2121-线程简介)auto        - [2.12.2. 线程模块](#2122-线程模块)auto        - [2.12.3. 数据共享](#2123-数据共享)auto        - [2.12.4. 线程锁](#2124-线程锁)auto        - [2.12.5. 自定义线程](#2125-自定义线程)auto        - [2.12.6. 定时线程](#2126-定时线程)auto        - [2.12.7. 信号传递(`Event`)](#2127-信号传递event)auto        - [2.12.8. 多核CPU(Python无法利用多线程实现多核任务)](#2128-多核cpupython无法利用多线程实现多核任务)auto        - [2.12.9. 进程 vs 线程](#2129-进程-vs-线程)auto    - [2.13. 异步`IO`](#213-异步io)auto        - [2.13.1. 计算密集型与`IO`密集型](#2131-计算密集型与io密集型)auto        - [2.13.2. 协程](#2132-协程)auto        - [2.13.3. `asyncio`](#2133-asyncio)auto        - [2.13.4. `async`/`await`](#2134-asyncawait)auto        - [2.13.5. `aiohttp`](#2135-aiohttp)auto    - [2.14. 网络编程](#214-网络编程)auto        - [2.14.1. 相关概念](#2141-相关概念)auto        - [2.14.2. `TCP`编程](#2142-tcp编程)auto        - [2.14.3. `UDP`编程](#2143-udp编程)auto- [3. 第三部分  Python与数据库](#3-第三部分--python与数据库)auto    - [3.1. `MySQL`](#31-mysql)auto        - [3.1.1. `MySQL`(`Ubuntu`)的安装](#311-mysqlubuntu的安装)auto        - [3.1.2. 数据库定义语言(`DDL`)](#312-数据库定义语言ddl)auto        - [3.1.3. 数据库操作语言(`DML`)](#313-数据库操作语言dml)auto        - [3.1.4. 数据库查询语言(`DQL`)](#314-数据库查询语言dql)auto        - [3.1.5. 数据控制语言(`DCL`)](#315-数据控制语言dcl)auto        - [3.1.6. 多表联合查询](#316-多表联合查询)auto        - [3.1.7. 多表联合操作](#317-多表联合操作)auto        - [3.1.8. 事务处理语言(`DTL`)](#318-事务处理语言dtl)auto        - [3.1.9. 外键索引(约束)](#319-外键索引约束)auto        - [3.1.10. 数据清空(`DELETE`与`TRUNCATE`)](#3110-数据清空delete与truncate)auto        - [3.1.11. 数据库的备份与恢复](#3111-数据库的备份与恢复)auto        - [3.1.12. `Python`操作`MySql`](#3112-python操作mysql)auto            - [3.1.12.1. `MySQLdb`](#31121-mysqldb)auto            - [3.1.12.2. `mysqlclient`](#31122-mysqlclient)auto            - [3.1.12.3. `PyMySQL`](#31123-pymysql)auto            - [3.1.12.4. `peewee`](#31124-peewee)auto            - [3.1.12.5. `SQLAlchemy`](#31125-sqlalchemy)auto            - [3.1.12.6. `Flask-SQLAlchemy`](#31126-flask-sqlalchemy)auto    - [3.2. `Redis`](#32-redis)auto        - [3.2.1. `Redis`的安装与连接测试](#321-redis的安装与连接测试)auto        - [3.2.2. `Redis`命令](#322-redis命令)auto        - [3.2.3. `Python`操作`Redis`](#323-python操作redis)auto            - [3.2.3.1. 简单连接](#3231-简单连接)auto            - [3.2.3.2. 连接池](#3232-连接池)auto            - [3.2.3.3. 详细操作命令](#3233-详细操作命令)auto            - [3.2.3.4. 管道(`pipeline`)](#3234-管道pipeline)auto            - [3.2.3.5. 发布和订阅](#3235-发布和订阅)auto    - [3.3. `MongoDB`](#33-mongodb)auto        - [3.3.1. `MongoDB`简介](#331-mongodb简介)auto        - [3.3.2. `MongoDB`基本操作](#332-mongodb基本操作)auto        - [3.3.3. `MongoDB`进阶操作](#333-mongodb进阶操作)auto        - [3.3.4. 权限认证](#334-权限认证)auto        - [3.3.5. `Python`操作`MongoDB`](#335-python操作mongodb)auto- [4. 第四部分  Linux相关知识](#4-第四部分--linux相关知识)auto    - [4.1. `Linux`系统简介](#41-linux系统简介)auto    - [4.2. `Linux`目录结构及`vim`](#42-linux目录结构及vim)auto    - [4.3. 文件操作](#43-文件操作)auto        - [4.3.1. 常识命令](#431-常识命令)auto        - [4.3.2. 查看文件](#432-查看文件)auto        - [4.3.3. 文件及目录](#433-文件及目录)auto        - [4.3.4. 用户及用户组](#434-用户及用户组)auto    - [4.4. 文件权限](#44-文件权限)auto    - [4.5. 文件搜索](#45-文件搜索)auto    - [4.6. 系统服务](#46-系统服务)auto        - [4.6.1. 压缩与解压](#461-压缩与解压)auto        - [4.6.2. 网络服务](#462-网络服务)auto        - [4.6.3. 服务监测](#463-服务监测)auto        - [4.6.4. 进程管理](#464-进程管理)auto        - [4.6.5. 防火墙(`ufw`)](#465-防火墙ufw)auto        - [4.6.6. 远程连接(`ssh:22`)](#466-远程连接ssh22)auto        - [4.6.7. 软件安装](#467-软件安装)auto        - [4.6.8 管道及`xargs`](#468-管道及xargs)auto        - [4.6.8 重定向](#468-重定向)auto- [5. 第五部分  Python-Flask框架](#5-第五部分--python-flask框架)auto- [6. 第六部分  Python-Django框架](#6-第六部分--python-django框架)auto- [7. 第七部分  Python-Tornado框架](#7-第七部分--python-tornado框架)auto- [8. 第八部分  Python爬虫基础](#8-第八部分--python爬虫基础)auto- [9. 第九部分  Python-Scrapy与分布式爬虫](#9-第九部分--python-scrapy与分布式爬虫)autoauto<!-- /TOC -->
...
# 5. 第五部分  Python-Flask框架

# 6. 第六部分  Python-Django框架

# 7. 第七部分  Python-Tornado框架

# 8. 第八部分  Python爬虫基础

# 9. 第九部分  Python-Scrapy与分布式爬虫
